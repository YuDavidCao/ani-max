...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? MainDashWidget() : OnBoardingWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: ChangePasswordNoLoginWidget.routeName,
          path: ChangePasswordNoLoginWidget.routePath,
          builder: (context, params) => ChangePasswordNoLoginWidget(),
        ),
        FFRoute(
