...
import 'pet_info_model.dart';
export 'pet_info_model.dart';

class PetInfoWidget extends StatefulWidget {
  const PetInfoWidget({super.key});

  static String routeName = 'PetInfo';
  static String routePath = '/petInfo';
...
class _PetInfoWidgetState extends State<PetInfoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetInfoModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PetInfoRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final petInfoPetInfoRecord = snapshot.data!;
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await petInfoPetInfoRecord.reference
                                          .update(createPetInfoRecordData(
                                        petName:
                                      ...
                                      context
                                          .pushNamed(MainDashWidget.routeName);
                                    },
                                    text: 'Change Info',
